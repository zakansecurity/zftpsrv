...
class ZFTPSRV(threading.Thread):
    ...
    def __init__(self, (conn, addr), ip, user, pwd, homedir, whitelist_ip):
        ...
        if addr[0] not in whitelist_ip.split(','):
            ...
            print ("[-] FAIL : Access from unauthorized ip! Check the whitelist IP : %s." % (self.whitelist_ip))
            sys.exit(1)
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                print ( "[-] FAIL : Connection is closed.")
                sys.exit(1)
            ...
            if not cmd: break
                ...
                try:
                    ...
                    print ("[-] FAIL : Requested Command isn\'t implemented yet !' : %s, ERROR = %s." % (cmd, err))
    ...
    def PORT(self, cmd): 
        ...
        print ("[-] Passive Mode isn\'t enabled, asking to set it.")
    ...
    def start_datasock(self):
        ...
        if self.pasvmode:
            ...
            print ( "[+] SUCCESS : Data Connection from %s \n" % addr[0] )
    ...
    def NLST(self, cmd):
        ...
        if os.path.exists(self.cwd):
            ...
            print ("[-] FAIL : The Directory %s doesn\'t exist." % (self.cwd))
...
if __name__=='__main__':
    ...
    try:
        ...
        print ( "[+] SUCCESS : The Z FTP Server is started on (%s, %s)." % (ip, port) )
    
        raw_input ("[*] Tape [ENTER] or [CTRL+C to quit].\n" )
